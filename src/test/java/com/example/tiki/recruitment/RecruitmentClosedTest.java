...
@SpringBootTest
@Transactional
public class RecruitmentClosedTest {
    ...
    void 게시물_마감_성공(){
        ...
        recruitmentService.closeRecruitmentPost(leader.getId(), recruitment.getId());
        ...
        for (Recruitment rec : recruitmentRepository.findAll()) {
            ...
            assertThat(rec.getClosedAt()).isNotNull();
            assertThat(rec.getRecruitmentStatus()).isEqualTo(RecruitmentStatus.CLOSE);
        }

    }

    @Test
    void 게시물_마감_실패_게시글존재X(){
        Recruitment recruitment = recruitmentRepository.save(Recruitment.builder()
                .teamId(team.getId())
                .title("테스트 제목")
                .content("테스트 내용")
        ...
        NotFoundException ex = assertThrows(NotFoundException.class,
                () -> recruitmentService.closeRecruitmentPost(leader.getId(), 100L));
    ...
    void 게시물_마감_실패_게시물_이미_닫힘(){
        ...
        assertThat(ex.getMessage()).isEqualTo("이미 닫힌 모집 공고입니다.");

    }

    @Test
    void 게시물_마감_실패_삭제된_게시물(){
        Recruitment recruitment = recruitmentRepository.save(Recruitment.builder()
                .teamId(team.getId())
                .title("테스트 제목")
                .content("테스트 내용")
        ...
        assertThat(ex.getMessage()).isEqualTo("삭제된 공고는 처리할 수 없습니다.");
    ...
    void 게시물_마감_실패_리더X(){
        ...
        ForbiddenException forbiddenException = assertThrows(ForbiddenException.class,
                () -> recruitmentService.closeRecruitmentPost(member.getId(), recruitment.getId()));
